// Neopixel
#define PIN 14      // PIN where neopixel / WS2811 strip is attached 
#define NUMLEDS 200   // Number of leds in the strip
#define RELAISPIN 12  /// If you use Sonoff TH10/16 Relay will sit on port 12, PIN 14 ist for the Pixelcontrol
